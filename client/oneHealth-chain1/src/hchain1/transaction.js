...
/*
  ...
  a library to create a new signed transaction for the HCHAIN1 family
...
function createTransaction(opts) {
  ...
  const transactionHeaderBytes = protobuf.TransactionHeader.encode({
    ...
    familyName: Address.HCHAIN1_FAMILY,
    familyVersion: Address.HCHAIN1_VERSION,
    ...
    // there are no dependencies for an HCHAIN1 transaction
    dependencies: [],
  ...
  return protobuf.Transaction.create({
    ...
    // the binary payload - HCHAIN1 uses utf8 CSV strings so we are
