...
/*
  ...
  library for reading the state of the HCHAIN2 namespace
...
const Encoding = require('../shared/hchain2encoding')
...
function State(restApiUrl) {
  ...
  // Return the last blockId commited using the HCHAIN2_NAMESPACE prefix address
  function getLastBlock() {
    return RestApi
      .getState(restApiUrl, Address.HCHAIN2_NAMESPACE)
      .then(function(body) {
  ...
  // load the list of persons using the HCHAIN2_NAMESPACE prefix address
